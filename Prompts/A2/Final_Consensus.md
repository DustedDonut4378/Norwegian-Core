...
- **Target CEFR Level:** A2 (Elementary). Sentences should be practical, 7-11 words long, with simple subordinate clauses.
...
2. **Linguistic Accuracy:** The Norwegian must be natural, grammatically perfect, and appropriate for A2.
3. **Length Constraint:** 7-11 words. If you must choose, favor a natural sentence that is slightly over the limit rather than a "perfect length" sentence that sounds artificial.
